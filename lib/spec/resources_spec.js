...
define( [
   ...
   describe( 'A ResourceHandler', function() {
      ...
      describe( 'when a didReplace event is published', function() {
         ...
         it( 'calls the corresponding handler with the event that occurred', function() {
         ...
         it( 'passes the event meta data to the corresponding handler', function() {
            expect( onReplaceSausageSpy ).toHaveBeenCalledWith( jasmine.any( Object ), jasmine.any( Object ) );
            var meta = onReplaceSausageSpy.calls[0].args[1];
      ...
      describe( 'when a didUpdate event is published', function() {
         ...
         it( 'passes event meta data to the corresponding handler', function() {
            expect( onUpdateSausageSpy ).toHaveBeenCalledWith( jasmine.any( Object ), jasmine.any( Object ) );
            var meta = onUpdateSausageSpy.calls[0].args[1];
