...
describe( 'An action request publisher', () => {
   ...
   describe( 'when created for a feature that is not defined', () => {

      describe( 'and optional is set to false', () => {

         it( 'an error is thrown', () => {
            expect( () => { actions.publisherForFeature( context, 'unknown' ); } ).toThrow();
         } );
      ...
      describe( 'and optional is set to true', () => {

         let publisher;

         beforeEach( () => {
            publisher = actions.publisherForFeature( context, 'unknown', { optional: true } );
         } );

         /////////////////////////////////////////////////////////////////////////////////////////////////////

         it( 'no error is thrown', () => {
            expect( () => { actions.publisherForFeature( context, 'unknown', { optional: true } ); } )
               .not.toThrow();
         } );

         /////////////////////////////////////////////////////////////////////////////////////////////////////

         it( 'the publisher is a noop', () => {
            publisher();
            expect( context.eventBus.publishAndGatherReplies ).not.toHaveBeenCalled();
            expect( context.eventBus.publish ).not.toHaveBeenCalled();
         } );

         /////////////////////////////////////////////////////////////////////////////////////////////////////

         it( 'the publisher returns a resolved promise', done => {
