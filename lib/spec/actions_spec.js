...
define( [
   ...
   describe( 'An ActionHandler', function() {
      ...
      describe( 'for a synchronous handler when one of the registered actions is published', function() {
         ...
         it( 'when the handler returns an object, sends a didTakeAction with this object as event blueprint (#33)', function() {
            handlerFunction.andReturn( { response: 42 } );
      ...
      describe( 'for an asynchronous handler when one of the registered actions is published', function() {
         ...
         it( 'when the done callback is called with an object, sends a didTakeAction with this object as event blueprint (#33)', function() {
            handlerFunction.andCallFake( function( event, meta, done ) { done( { response: 42 } ); } );
      ...
      describe( 'when the asynchronous handler returns a promise', function() {
         ...
         beforeEach( function() {
            ...
            handlerFunction = jasmine.createSpy( 'handlerFunction' ).andReturn( deferred.promise );
         ...
         it( 'when the promise is resolved, sends a didTakeAction with outcome SUCCESS (#23)', function() {
            deferred.resolve();
         ...
         it( 'when the promise is rejected, sends a didTakeAction with outcome ERROR (#23)', function() {
            deferred.reject();
         ...
         it( 'when the promise is resolved with an object, sends a didTakeAction with this object as event blueprint (#33)', function() {
            deferred.resolve( { response: 42 } );
