...
import { log, object, _tooling } from 'laxar';
...
describe( 'A validation pattern library', () => {
   ...
   describe( 'with a method to create validation success events', () => {
      ...
      it( 'supports messages as varargs (jira ATP-7234)', () => {
...
describe( 'A ValidationHandler', () => {
   ...
   beforeEach( () => {
      ...
      asynchronousHandler = jasmine.createSpy( 'asynchronousHandler' ).and.returnValue( deferred.promise );
   ...
   describe( 'when a synchronous handler throws an exception', () => {
      ...
      it( 'an error is logged', () => {
         ...
         expect( log.error ).toHaveBeenCalledWith( 'Stacktrace for previous error: [0]', anyString );
      } );
      ...
      describe( 'when a specific message was configured', () => {
         ...
         beforeEach( done => {
            ...
            object.setPath( global, 'laxar.lib.laxar-patterns.validation.i18nHtmlExceptionMessage', {
