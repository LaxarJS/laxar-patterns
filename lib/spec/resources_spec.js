...
define( [
   ...
   describe( 'A standard didUpdate-event publisher', function() {
      ...
      describe( 'creates a function to send didUpdate events with data', function() {

         it( 'which publishes the event when called with non-empty updates', function() {
         ...
         it( 'which also publishes the event when called with empty data', function() {
      ...
      describe( 'creates a function to send didUpdate events with updates', function() {
         ...
         it( 'which does not publish any event when called with empty updates', function() {
            var returnedPromise = publisher( {} );
      ...
      describe( 'creates a function to send didUpdate events with patches', function() {


         it( 'which publishes the event when called with non-empty patches', function() {
         ...
         it( 'which does not publish any event when called with empty patches', function() {
            var returnedPromise = publisher( null, null, {} );
