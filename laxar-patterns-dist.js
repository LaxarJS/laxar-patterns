System.register('lib/actions.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'laxar'], function (_export) {var _Promise, assert, object, 
   ...
   function publisherForFeature(scope, feature, optionalOptions) {
      var action = object.path(scope.features, feature + '.action', null);
   ...
   function publisher(scope, action, optionalOptions) {
      assert(scope).hasType(Object).hasProperty('eventBus');
      ...
      return function (optionalEvent) {
         var event = object.options(optionalEvent, { action: action });
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_babelRuntimeCoreJsPromise) {_Promise = _babelRuntimeCoreJsPromise['default'];}, function (_laxar) {assert = _laxar.assert;object = _laxar.object;}], execute: function () {/**
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             */ /**
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 *
                                                                                                                                                                                                                 * @module actions
                                                                                                                                                                                                                 */'use strict';DELIVER_TO_SENDER = { deliverToSender: false };OUTCOME_SUCCESS = 'SUCCESS';OUTCOME_ERROR = 'ERROR';ActionHandler.prototype.registerActionsFromFeature = function (feature, handler) {var actions = object.path(this.scope_.features, feature + '.onActions') || [];return this.registerActions(actions, handler);}; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /**
          ...
          * @return {ActionHandler}
          *    this instance for chaining
          */ActionHandler.prototype.registerActions = function (actions, handler) {assert(actions).hasType(Array).isNotNull();assert(handler).hasType(Function).isNotNull();var self = this;actions.forEach(function (action) {self.scope_.eventBus.subscribe('takeActionRequest.' + action, function (event, meta) {callHandler(self.scope_.eventBus, action, handler, event, meta);});});return this;};_export('publisher', publisher);_export('publisherForFeature', publisherForFeature);_export('handlerFor', handlerFor);_export('OUTCOME_ERROR', OUTCOME_ERROR);_export('OUTCOME_SUCCESS', OUTCOME_SUCCESS);} };});
...
System.register('lib/errors.js', ['laxar'], function (_export) {/**
    ...
    */'use strict';var assert, object, string;
   function errorPublisherForFeature(scope, featurePath, options) {
      ...
      var featureConfiguration = object.path(scope.features, featurePath);
      assert(featureConfiguration).hasType(Object).isNotNull();

      return function (code, messagePath, data, cause) {
         var rawMessage = object.path(featureConfiguration, messagePath);
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_laxar) {assert = _laxar.assert;object = _laxar.object;string = _laxar.string;}], execute: function () {_export('errorPublisherForFeature', 
...
System.register('lib/flags.js', ['laxar'], function (_export) {/**
   ...
   evaluators;function handlerFor(scope) {return new FlagHandler(scope);} //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   /**
    *
    * @param scope
    *
    * @constructor
    * @private
    */function FlagHandler(scope) {this.scope_ = scope;} //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   /**
    ...
    *    this instance for chaining
    */ //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   function processFlags(flags) {if (!flags) {return [];}var flagArr = Array.isArray(flags) ? flags : [flags];return flagArr.map(function (flagExpression) {var negated = flagExpression.indexOf('!') === 0;return { name: negated ? flagExpression.substr(1) : flagExpression, negated: negated, state: negated // always the state after applying a possible negation
         };});} //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   function processChangeHandlers(handlers) {if (!handlers) {return function () {};}var handlerArr = Array.isArray(handlers) ? handlers : [handlers];return function (newValue, oldValue) {handlerArr.forEach(function (handler) {handler(newValue, oldValue);});};} //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   function evaluateState(flags, predicate) {var state = flags.reduce(evaluators[predicate], null);return state === null ? false : state;} //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_laxar) {object = _laxar.object;}], execute: function () {FlagHandler.prototype.registerFlagFromFeature = function (featurePath, optionalOptions) {return this.registerFlag(object.path(this.scope_.features, featurePath, []), optionalOptions);}; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /**
          ...
          * @return {FlagHandler}
          *    this instance for chaining
          */FlagHandler.prototype.registerFlag = function (possibleFlags, optionalOptions) {optionalOptions = object.options(optionalOptions, { predicate: 'any' });var scope = this.scope_;var applyToScope = 'scopeKey' in optionalOptions ? function (state) {return object.setPath(scope, optionalOptions.scopeKey, state);} : function () {};var flags = processFlags(possibleFlags);var changeHandler = processChangeHandlers(optionalOptions.onChange);var oldState = typeof optionalOptions.initialState === 'boolean' ? optionalOptions.initialState : evaluateState(flags, optionalOptions.predicate);applyToScope(oldState);flags.forEach((function (flag) {this.scope_.eventBus.subscribe('didChangeFlag.' + flag.name, (function (event) {flag.state = flag.negated ? !event.state : event.state;var newState = evaluateState(flags, optionalOptions.predicate);if (newState !== oldState) {applyToScope(newState);changeHandler(newState, oldState);oldState = newState;}}).bind(this));}).bind(this));return this;};evaluators = { any: function any(previousValue, flag) {return previousValue === null ? flag.state : flag.state || previousValue;}, all: function all(previousValue, flag) {return previousValue === null ? flag.state : flag.state && previousValue;} }; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
System.register('lib/i18n.js', ['laxar'], function (_export) {/**
   ...
   function handlerFor(scope, optionalI18nPath) {
      ...
      function handleLocaleChangeEvent(event) {
         ...
         var tags = object.path(scope, i18nPath).tags;
      ...
      var handler = { 
         ...
         registerLocaleFromFeature: function registerLocaleFromFeature(featurePath, optionalOptions) {
            var entry = object.path(scope.features, featurePath);
         ...
         localizer: function localizer(fallback) {
            var model = object.path(scope, i18nPath);
            ...
            partial.format = function () {for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
               var i18nLocalizer = i18n.localizer(model.tags[model.locale]);
               return i18nLocalizer.format.apply(i18nLocalizer, args);};
      ...
      function prepareScopeI18n() {
         var result = object.path(scope, i18nPath);
         if (!result) {
            result = {};
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_laxar) {i18n = _laxar.i18n;object = _laxar.object;}], execute: function () {_export('handlerFor', 
...
System.register('lib/json.js', ['fast-json-patch', 'laxar'], function (_export) {/**
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_fastJsonPatch) {jsonPatch = _fastJsonPatch['default'];}, function (_laxar) {ax = _laxar;}], execute: function () {_export('getPointer', 


         getPointer);_export('setPointer', 
         setPointer);_export('pointerToPath', 
         pointerToPath);_export('pathToPointer', 
         pathToPointer);_export('applyPatch', 

         applyPatch);_export('createPatch', 
         createPatch);} };}); // rfc-6901 helpers
// rfc-6902 helpers

System.register('lib/patches.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', 'laxar'], function (_export) {var _Object$keys, object;
   ...
   function apply(obj, patchMap) {
      ...
      _Object$keys(patchMap).
      sort(function (a, b) {return a.length - b.length;}).
      forEach(function (path) {return object.setPath(obj, path, patchMap[path]);});}
      ...
      function createPatchesRecursively(result, base, path) {
         for (var key in result) {
            if (result.hasOwnProperty(key) && (key.charAt(0) !== '$' || key.charAt(1) !== '$')) {
               ...
               if (base[key] == null) {
                  patches[nextPath.join('.')] = clean(object.deepClone(val));} else 

               {
                  if (val && typeof val === 'object') {
                     createPatchesRecursively(val, base[key], nextPath);} else 
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_babelRuntimeCoreJsObjectKeys) {_Object$keys = _babelRuntimeCoreJsObjectKeys['default'];}, function (_laxar) {object = _laxar.object;}], execute: function () {/**
                                                                                                                                                                                                * Copyright 2016 aixigo AG
                                                                                                                                                                                                * Released under the MIT license.
                                                                                                                                                                                                * http://laxarjs.org/license
                                                                                                                                                                                                */ /**
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    *
                                                                                                                                                                                                    * @module patches
                                                                                                                                                                                                    */'use strict';_export('apply', apply);_export('create', create);_export('merge', merge);} };});

System.registerDynamic("npm:fast-json-patch@0.5.6/src/json-patch-duplex.js", [], true, function($__require, exports, module) {
  ;
  var global = this,
...
System.registerDynamic("npm:fast-json-patch@0.5.6.js", ["npm:fast-json-patch@0.5.6/src/json-patch-duplex"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.register('lib/resources.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'fast-json-patch', 'laxar'], function (_export) {var _Promise, jsonPatch, assert, log, object;
   ...
   function replacePublisherForFeature(context, featurePath, optionalOptions) {
      ...
      var resourceName = object.path(context.features, featurePath + '.resource');
      if (!resourceName && options.isOptional) {
         return function () {return _Promise.resolve();};}
   ...
   function updatePublisherForFeature(context, featurePath, optionalOptions) {
      ...
      var resourceName = object.path(context.features, featurePath + '.resource');
      if (!resourceName && options.isOptional) {
         var noopPublisher = function noopPublisher() {return _Promise.resolve();};
      ...
      publisher.compareAndPublish = function (from, to) {return publisher(jsonPatch.compare(from, to));};
   ...
   function registerResourceHandlers(self, resource, options) {
      ...
      function ignoringFirstCall(f) {var _arguments = arguments;
         var ignore = true;
         return function () {
            if (!ignore) {return f.apply(self, _arguments);}
            ignore = false;};}
   ...
   function registerForReplace(self, resource, options) {
      ...
      self.context_.eventBus.subscribe('didReplace.' + resource, function (event, meta) {
         ...
         try {
            self.externalHandlers_[resource].onReplace.forEach(function (handler) {return handler(event, meta);});} finally 
   ...
   function registerForUpdate(self, resource, options) {
      ...
      self.context_.eventBus.subscribe('didUpdate.' + resource, function (event, meta) {
         ...
         try {
            self.externalHandlers_[resource].onUpdate.forEach(function (handler) {return handler(event, meta);});} finally 
   ...
   function isSame(resourceA, resourceB, compareAttributes) {
      ...
      for (var i = 0; i < compareAttributes.length; ++i) {
         ...
         if (key.indexOf('.') !== -1) {
            ...
            var valueA = object.path(resourceA, key);
            var valueB = object.path(resourceB, key);
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_babelRuntimeCoreJsPromise) {_Promise = _babelRuntimeCoreJsPromise['default'];}, function (_fastJsonPatch) {jsonPatch = _fastJsonPatch['default'];}, function (_laxar) {assert = _laxar.assert;log = _laxar.log;object = _laxar.object;}], execute: function () {/**
                                                                                                                                                                                                                                                                                                  * Copyright 2016 aixigo AG
                                                                                                                                                                                                                                                                                                  * Released under the MIT license.
                                                                                                                                                                                                                                                                                                  * http://laxarjs.org/license
                                                                                                                                                                                                                                                                                                  */ /**
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      *
                                                                                                                                                                                                                                                                                                      * @module resources
                                                                                                                                                                                                                                                                                                      */'use strict';ResourceHandler.prototype.registerResourceFromFeature = function (featurePath, optionalOptions) {var resource = object.path(this.context_.features, featurePath + '.resource', null);var options = object.options(optionalOptions, { isOptional: false });if (resource === null && options.isOptional) {return this;}assert(resource).isNotNull('Could not find resource configuration in features for "' + featurePath + '"');if (!options.modelKey) {options.modelKey = featurePath.substr(featurePath.lastIndexOf('.') + 1);}return this.registerResource(resource, options);}; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /**
          ...
          * @return {ResourceHandler}
          *    this instance for chaining
          */ResourceHandler.prototype.registerResource = function (resource, optionalOptions) {assert(resource).hasType(String).isNotNull();var options = object.options(optionalOptions, { omitFirstReplace: false, modelKey: resource });this.waitingFor_.push(resource);registerResourceHandlers(this, resource, options);if (!(resource in this.modelHandlers_)) {this.modelHandlers_[resource] = {};}registerForReplace(this, resource, options);registerForUpdate(this, resource, options);return this;}; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /**
          ...
          * @return {ResourceHandler}
          *    this instance for chaining
          */ResourceHandler.prototype.whenAllWereReplaced = function (callback, optionalOptions) {assert(callback).hasType(Function).isNotNull();this.allReplacedCallback_ = optionalOptions && optionalOptions.watch ? callback : onceCallback;return this;function onceCallback() {callback();callback = function () {};}}; //////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /**
          ...
          */ResourceHandler.prototype.wereAllReplaced = function () {return !this.waitingFor_.length;};_export('replaceHandler', replaceHandler);_export('updateHandler', updateHandler);_export('replacePublisherForFeature', replacePublisherForFeature);_export('updatePublisherForFeature', updatePublisherForFeature);_export('isSame', isSame);_export('handlerFor', handlerFor);} };});

System.register('lib/validation.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'laxar'], function (_export) {var _Promise, assert, configuration, log, object;
   ...
   function handlerFor(context) {
      ...
      function registerResourceFromFeature(featurePath, validator, optionalOptions) {
         ...
         var options = object.options(optionalOptions, { isOptional: false });

         var resource = object.path(context.features, featurePath + '.resource', null);
      ...
      function callValidator(resource, validator) {
         ...
         try {
            ...
            then(function (result) {
               ...
               eventBus.publish('didValidate.' + resource + '.' + event.outcome, event);})['catch'](

            handleError.bind(null, resource));} 
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_babelRuntimeCoreJsPromise) {_Promise = _babelRuntimeCoreJsPromise['default'];}, function (_laxar) {assert = _laxar.assert;configuration = _laxar.configuration;log = _laxar.log;object = _laxar.object;}], execute: function () {/**
                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                   */ /**
                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                       *
                                                                                                                                                                                                                                                                       * @module validation
                                                                                                                                                                                                                                                                       */'use strict';_export('successEvent', successEvent);_export('errorEvent', errorEvent);_export('handlerFor', handlerFor);} };});
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/i18n/i18n.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/assert', '../utilities/string', '../utilities/configuration'], function (_export) {var _Object$keys, assert, string, configuration, 
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/fn.js", [], function (_export) {/**
                                                                                                   * Copyright 2016 aixigo AG
                                                                                                   * Released under the MIT license.
                                                                                                   * http://laxarjs.org/license
                                                                                                   */
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/browser.js", [], function (_export) {/**
                                                                                                      * Copyright 2016 aixigo AG
                                                                                                      * Released under the MIT license.
                                                                                                      * http://laxarjs.org/license
                                                                                                      */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/event_bus/event_bus.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/assert', '../logging/log', '../utilities/object'], function (_export) {var _Promise, _Object$keys, assert, log, object, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/storage.js', ['./assert', './configuration'], function (_export) {/**
                                                                                                                                     * Copyright 2016 aixigo AG
                                                                                                                                     * Released under the MIT license.
                                                                                                                                     * http://laxarjs.org/license
                                                                                                                                     */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/timer.js', ['./object', './storage', '../logging/log'], function (_export) {/**
                                                                                                                                               * Copyright 2016 aixigo AG
                                                                                                                                               * Released under the MIT license.
                                                                                                                                               * http://laxarjs.org/license
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0/static/schemas/flow.js", [], function (_export) {/**
                                                                                                      * Copyright 2016 aixigo AG
                                                                                                      * Released under the MIT license.
                                                                                                      * http://laxarjs.org/license
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/flow_service.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', 'npm:babel-runtime@5.8.34/core-js/get-iterator.js', 'page', '../json/validator', '../utilities/object', '../utilities/path', '../utilities/timer', '../logging/log', '../../static/schemas/flow'], function (_export) {var _Object$keys, _getIterator, pageRouter, createJsonValidator, object, path, timer, log, flowSchema, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/file_resource_provider/file_resource_provider.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/assert', '../utilities/path', '../utilities/configuration'], function (_export) {var _Promise, _Object$keys, assert, path, configuration, 
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/heartbeat.js", [], function (_export) {/**
                                                                                                        * Copyright 2016 aixigo AG
                                                                                                        * Released under the MIT license.
                                                                                                        * http://laxarjs.org/license
                                                                                                        */"use strict";_export("create", create);
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/area_helper.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'npm:babel-runtime@5.8.34/core-js/array/from.js', '../utilities/object'], function (_export) {var _Promise, _Array$from, forEach;
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/layout_widget_adapter.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', './area_helper'], function (_export) {var _Object$keys, findWidgetAreas;
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/page_service.js', ['npm:babel-runtime@5.8.34/helpers/to-consumable-array.js', 'npm:babel-runtime@5.8.34/core-js/promise.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/assert', './area_helper', './layout_widget_adapter', '../tooling/pages'], function (_export) {var _toConsumableArray, _Promise, _Object$keys, assert, createAreaHelper, findWidgetAreas, createLayoutWidgetAdapter, pageTooling;
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/locale_event_manager.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/object'], function (_export) {var _Promise, _Object$keys, deepClone, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/visibility_event_manager.js', ['npm:babel-runtime@5.8.34/core-js/promise.js'], function (_export) {var _Promise, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/loaders/css_loader.js', ['../utilities/object', '../utilities/path'], function (_export) {/**
                                                                                                                                                   * Copyright 2016 aixigo AG
                                                                                                                                                   * Released under the MIT license.
                                                                                                                                                   * http://laxarjs.org/license
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/loaders/layout_loader.js', ['../utilities/path'], function (_export) {/**
                                                                                                                               * Copyright 2016 aixigo AG
                                                                                                                               * Released under the MIT license.
                                                                                                                               * http://laxarjs.org/license
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0/static/schemas/page.js", [], function (_export) {/**
                                                                                                      * Copyright 2016 aixigo AG
                                                                                                      * Released under the MIT license.
                                                                                                      * http://laxarjs.org/license
                                                                                                      */"use strict";return { setters: [], execute: function () {_export("default", 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/json/schema.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js'], function (_export) {var _Object$keys;
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/json/validator.js', ['jjv', 'jjve', './schema', '../utilities/object'], function (_export) {/**
                                                                                                                                                     * Copyright 2016 aixigo AG
                                                                                                                                                     * Released under the MIT license.
                                                                                                                                                     * http://laxarjs.org/license
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/loaders/features_provider.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', '../json/validator', '../utilities/object'], function (_export) {var _Object$keys, jsonValidator, object, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/string.js', ['npm:babel-runtime@5.8.34/core-js/object/freeze.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js'], function (_export) {var _Object$freeze, _Object$keys, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/loaders/paths.js', [], function (_export) {/**
                                                                                                    * Copyright 2016 aixigo AG
                                                                                                    * Released under the MIT license.
                                                                                                    * http://laxarjs.org/license
                                                                                                    */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/controls_service.js', ['../utilities/path', '../utilities/string', '../loaders/paths'], function (_export) {/**
                                                                                                                                                                             * Copyright 2016 aixigo AG
                                                                                                                                                                             * Released under the MIT license.
                                                                                                                                                                             * http://laxarjs.org/license
                                                                                                                                                                             */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/path.js', ['./assert'], function (_export) {/**
                                                                                                               * Copyright 2016 aixigo AG
                                                                                                               * Released under the MIT license.
                                                                                                               * http://laxarjs.org/license
                                                                                                               */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/runtime/theme_manager.js', ['npm:babel-runtime@5.8.34/core-js/promise.js', '../utilities/path'], function (_export) {var _Promise, path;
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/widget_adapters/plain_adapter.js', [], function (_export) {/**
                                                                                                                    * Copyright 2016 aixigo AG
                                                                                                                    * Released under the MIT license.
                                                                                                                    * http://laxarjs.org/license
                                                                                                                    */'use strict';var 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/widget_adapters/adapters.js', ['npm:babel-runtime@5.8.34/helpers/define-property.js', 'npm:babel-runtime@5.8.34/core-js/object/keys.js', './plain_adapter'], function (_export) {var _defineProperty, _Object$keys, plainAdapter, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/assert.js', [], function (_export) {/**
                                                                                                       * Copyright 2016 aixigo AG
                                                                                                       * Released under the MIT license.
                                                                                                       * http://laxarjs.org/license
                                                                                                       */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/configuration.js', ['./object'], function (_export) {/**
                                                                                                                        * Copyright 2016 aixigo AG
                                                                                                                        * Released under the MIT license.
                                                                                                                        * http://laxarjs.org/license
                                                                                                                        */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/logging/console_channel.js', [], function (_export) {/**
                                                                                                              * Copyright 2016 aixigo AG
                                                                                                              * Released under the MIT license.
                                                                                                              * http://laxarjs.org/license
                                                                                                              */'use strict';var 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/utilities/object.js', ['npm:babel-runtime@5.8.34/core-js/object/is-frozen.js', 'npm:babel-runtime@5.8.34/core-js/object/freeze.js'], function (_export) {var _Object$isFrozen, _Object$freeze, 
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/logging/log.js', ['../utilities/assert', '../utilities/configuration', './console_channel', '../utilities/object'], function (_export) {/**
                                                                                                                                                                                                 * Copyright 2016 aixigo AG
                                                                                                                                                                                                 * Released under the MIT license.
                                                                                                                                                                                                 * http://laxarjs.org/license
                                                                                                                                                                                                 */
...
System.register('github:LaxarJS/laxar@2.0.0-alpha.0/lib/tooling/pages.js', ['npm:babel-runtime@5.8.34/core-js/object/keys.js', '../utilities/object', '../logging/log'], function (_export) {var _Object$keys, deepClone, log, 
...
System.register("github:LaxarJS/laxar@2.0.0-alpha.0.js", ["github:LaxarJS/laxar@2.0.0-alpha.0/laxar.js"], function (_export) {"use strict";return { setters: [function (_githubLaxarJSLaxar200Alpha0LaxarJs) {var _exportObj = {};for (var _key in _githubLaxarJSLaxar200Alpha0LaxarJs) {if (_key !== "default") _exportObj[_key] = _githubLaxarJSLaxar200Alpha0LaxarJs[_key];}_exportObj["default"] = _githubLaxarJSLaxar200Alpha0LaxarJs["default"];_export(_exportObj);}], execute: function () {} };});
...
System.register('lib/visibility.js', ['laxar'], function (_export) {/**
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////
   return { setters: [function (_laxar) {object = _laxar.object;}], execute: function () {VisibilityHandler.prototype.registerArea = function (areaName, optionalOptions) {var options = object.options(optionalOptions, {});if (options.onRequest) {var requestEvent = 'changeAreaVisibilityRequest.' + areaName;this.scope_.eventBus.subscribe(requestEvent, responder(this, options.onRequest));}return this;};_export('handlerFor', 

         handlerFor);_export('requestPublisherForWidget', 
         requestPublisherForWidget);_export('requestPublisherForArea', 
         requestPublisherForArea);} };});

System.register('laxar-patterns.js', ['./lib/actions', './lib/errors', './lib/flags', './lib/i18n', './lib/json', './lib/patches', './lib/resources', './lib/validation', './lib/visibility'], function (_export) {/**
                                                                                                                                                                                                                    * Copyright 2016 aixigo AG
                                                                                                                                                                                                                    * Released under the MIT license.
                                                                                                                                                                                                                    * http://laxarjs.org/license
                                                                                                                                                                                                                    */'use strict';var actions, errors, flags, i18n, json, patches, resources, validation, visibility;return { setters: [function (_libActions) {actions = _libActions;}, function (_libErrors) {errors = _libErrors;}, function (_libFlags) {flags = _libFlags;}, function (_libI18n) {i18n = _libI18n;}, function (_libJson) {json = _libJson;}, function (_libPatches) {patches = _libPatches;}, function (_libResources) {resources = _libResources;}, function (_libValidation) {validation = _libValidation;}, function (_libVisibility) {visibility = _libVisibility;}], execute: function () {_export('actions', 
         ...
         actions);_export('errors', 
         errors);_export('flags', 
         flags);_export('i18n', 
         i18n);_export('json', 
         json);_export('patches', 
         patches);_export('resources', 
         resources);_export('validation', 
         validation);_export('visibility', 
         visibility);} };});
