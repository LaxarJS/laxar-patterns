...
define( [
   ...
   function connectPublisherToFeature( scope, feature, optionalOptions ) {
      var topic = ax.object.path( scope.features, feature );
      var publisher = topic ? publisherForFeature( scope, feature, optionalOptions ) : NOOP;
      ax.object.setPath( scope, 'actions.' + feature, publisher );
   }
